# Hybrid Detection of AI-Generated Text
...
- `notebook_llm_A.ipynb` # Experiments using GPT-2 variants for repair score computation
- `notebook_llm_B.ipynb` # Experiments using Pythia variants for repair score computation
- ReadMe.md
